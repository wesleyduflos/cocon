...
export const DEFAULT_MAINTENANCE_PRESETS: MaintenancePresetSeed[] = [
  // ---------- Poubelles & tri (collectes de la commune Wesley) -------------
  {
    seedId: "trash-grey",
    category: "trash",
    title: "Ordures ménagères",
    emoji: "🗑️",
    hint: "À sortir avant 16h",
    recurrenceRule: "FREQ=WEEKLY;BYDAY=MO",
    frequencyLabel: "Lundi soir",
    position: 0,
  },
  {
    seedId: "trash-yellow",
    category: "trash",
    title: "Papiers / emballages",
    emoji: "♻️",
    hint: "À sortir avant 16h",
    recurrenceRule: "FREQ=WEEKLY;BYDAY=FR",
    frequencyLabel: "Vendredi soir",
    position: 1,
  },
  {
    seedId: "trash-green",
    ...
    title: "Végétaux",
    emoji: "🌿",
    hint: "À sortir avant 16h · 17/02 + 15/12 en exception",
    recurrenceRule: "FREQ=WEEKLY;BYDAY=TU",
    frequencyLabel: "Mardi soir (sauf février)",
    position: 2,
  },
  {
    seedId: "trash-glass",
    ...
    frequencyLabel: "1ᵉʳ lundi du mois",
    position: 3,
  },
  {
    seedId: "trash-bulky",
    ...
    emoji: "📦",
    hint: "À sortir avant 16h",
    recurrenceRule: "FREQ=MONTHLY;BYDAY=2WE",
    frequencyLabel: "2ᵉ mercredi du mois",
    position: 4,
  },
  {
